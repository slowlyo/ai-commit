...
const messages = {
  en: {
    ...
    'error.apiKeyMissingProfile': 'API Key is not configured for profile "{profile}".',
    ...
    'error.fetchModelsFailed':
      'Failed to fetch models for profile "{profile}": {message}. Please check its API Key and Base URL.',
    'error.gitExtensionMissing': 'Git extension not found',
    'error.nameRequired': 'Profile name is required',
    ...
    'placeholder.selectModelWithProfile': 'Select model for profile "{profile}"',
    'placeholder.selectProfile': 'Select an OpenAI configuration profile to activate',
    'profile.active': 'Active',
    'profile.addNewProfile': 'Add New Profile...',
    'profile.addNewProfileDetail':
      'Create a new OpenAI-compatible configuration profile',
    'profile.currentModel': 'Current Model',
    'profile.currentModelCustom': 'Current Model (Custom)',
    'profile.inputApiKey': 'API Key',
    'profile.inputApiKeyPlaceholder': 'Enter API Key',
    'profile.inputBaseUrl': 'Base URL (Optional)',
    'profile.inputBaseUrlPlaceholder': 'e.g. https://api.openai.com/v1',
    'profile.inputModel': 'Model Name',
    'profile.inputModelPlaceholder': 'e.g. gpt-5-mini, deepseek-chat',
    'profile.inputName': 'Profile Name',
    'profile.inputNamePlaceholder': 'e.g. DeepSeek, OpenAI, Ollama',
    'profile.switched': 'Switched to profile: {name}',
    'profile.createdAndActivated': 'Profile "{name}" created and activated',
    'progress.analyzingChanges': 'Analyzing changes...',
    'progress.analyzingChangesWithContext':
      'Analyzing changes with additional context...',
    'progress.fetchingModels': 'Fetching available models for profile "{profile}"...',
  ...
  zh: {
    ...
    'error.apiKeyMissingProfile': '配置档案“{profile}”未配置 API Key。',
    ...
    'error.fetchModelsFailed':
      '获取配置档案“{profile}”的模型列表失败：{message}。请检查该档案的 API Key 和 Base URL。',
    'error.gitExtensionMissing': '未找到 Git 扩展',
    'error.nameRequired': '必须输入配置档案名称',
    ...
    'placeholder.selectProfile': '选择要启用的 OpenAI 配置档案',
    'profile.active': '当前启用',
    'profile.addNewProfile': '添加新配置档案...',
    'profile.addNewProfileDetail': '创建一组新的 OpenAI (兼容) 配置档案',
    'profile.currentModel': '当前模型',
    'profile.currentModelCustom': '当前模型（自定义）',
    'profile.inputApiKey': 'API Key',
    'profile.inputApiKeyPlaceholder': '请输入 API Key',
    'profile.inputBaseUrl': 'Base URL（可选）',
    'profile.inputBaseUrlPlaceholder': '例如：https://api.openai.com/v1',
    'profile.inputModel': '模型名称',
    'profile.inputModelPlaceholder': '例如：gpt-5-mini、deepseek-chat',
    'profile.inputName': '配置档案名称',
    'profile.inputNamePlaceholder': '例如：DeepSeek、OpenAI、Ollama',
    'profile.switched': '已切换到配置档案：{name}',
    'profile.createdAndActivated': '已创建并启用配置档案：{name}',
    'progress.analyzingChanges': '正在分析变更...',
    'progress.analyzingChangesWithContext': '正在结合额外上下文分析变更...',
    'progress.fetchingModels': '正在获取配置档案“{profile}”的可用模型...',
